    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="product_add.php"><i class="fa fa-product-hunt"></i> <span>Add Product</span></a></li>
          <li><a href="product_list.php"><i class="fa fa-th-list"></i> <span>All Products</span></a></li>
